...
namespace IDB.Navigator.Site.Components.Extensions
{
    public static class HtmlExtensions
    {
        public static MvcHtmlString NavigatorValidationMessageFor<TModel, TProperty>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TProperty>> expression, object htmlAttributes)
        {
